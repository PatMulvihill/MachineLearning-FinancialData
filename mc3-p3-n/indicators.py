...
symbols = 'JPM'
price = get_data([symbols], pd.date_range(start_date_train,end_date_train))
del price['SPY']
price = price/price.ix[0]


sma, sma_n, bbp, top_band, bottom_band, momentum = caculate( symbols, sd=dt.datetime(2008,1,1), ed=dt.datetime(2009,12,31))
...
del bbp['SPY']
price_n = get_data([symbols], pd.date_range(start_date_train,end_date_train))

del price_n['SPY']
del top_band['SPY']
del bottom_band['SPY']
sma1, sma_n1, bbp1, top_band1, bottom_band1, momentum1 = caculate( symbols, sd=dt.datetime(2008,1,1), ed=dt.datetime(2009,12,31))
del sma1['SPY']
