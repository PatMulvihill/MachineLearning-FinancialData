...
class Strategy_experiment1(object):

    # constructor
    def __init__(self, verbose = False, impact=0.0):
        self.verbose = verbose
        self.impact = impact
        self.qlearner = ql.QLearner(num_states=100, \
                                   num_actions=3, \
                                   alpha=0.2, \
                                   gamma=0.9, \
                                   rar=0.5, \
    ...
    def addEvidence(self, symbol = "IBM", \
        ...
        strategy =  train_SMAPrice_ratio_n  + train_bbp_n*10
    ...
    def testPolicy(self, symbol="IBM", \
        ...
        test_strategy_states = (test_SMA_ratio_n + test_bbp_n*10).values
