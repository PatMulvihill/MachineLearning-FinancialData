        ...
        if group=='nodyna':
            def timeoutwrapper_nodyna():
                learner = QLearner.QLearner(num_states=100,\
                                            ...
                                            dyna = 0, \
                                            verbose=False)
                return qltest(worldmap=world,iterations=500,learner=learner,verbose=False)
            ...
            def timeoutwrapper_dyna():
                learner = QLearner.QLearner(num_states=100,\
                                            ...
                                            dyna = 200, \
                                            verbose=False)
                return qltest(worldmap=world,iterations=50,learner=learner,verbose=False)
...
def qltest(worldmap, iterations, learner, verbose):
